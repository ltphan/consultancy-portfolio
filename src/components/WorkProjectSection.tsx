...
const projects = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      solution:
        "I built and delivered Clio's first consumer-facing product from the ground up. The mobile application included high-value features such as secure messaging, document sharing with e-signature capabilities, case timeline viewing, and appointment scheduling. All features were built with end-to-end usability in mind for lawyers' clients",
      results:
